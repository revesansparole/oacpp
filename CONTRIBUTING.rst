...
Ready to contribute? Here's how to set up `oacpp` for local development.

1. Fork the `oacpp` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/oacpp.git
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/revesansparole/oacpp/pull_requests
...
.. _issues: https://github.com/revesansparole/oacpp/issues
