...
# -*- coding: utf-8 -*-
#
# Package (Undefined, u'oacpp') documentation build configuration file, created by
...
texinfo_documents = [
    ('index', 'oacpp',
     ...
     u'revesansparole',
     'oacpp',
     'Test package for CPP Python interaction',
     'Miscellaneous'),
]
